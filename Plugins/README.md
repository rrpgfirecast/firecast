...
Subpastas:
- ChatMods/
	Plugins que alteram ou adicionam funcionalidades ao chat do firecast
	 
- Core/
	Plugins básicos do Firecast
	
- Sheets/
	Plugins de modelos de fichas
	
- TablesDock/
	Plugins de janelas acopláveis 
	
- Template/
	Template criado por Ambesek para criar plugins para o Firecast
