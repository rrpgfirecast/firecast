...
local function constructNew_frmLojinha()
    ...
    obj:beginUpdate();
    obj:setName("frmLojinha");
    obj:setFormType("sheetTemplate");
    obj:setDataType("LojaDinamica");
...
function newfrmLojinha()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmLojinha();
      end,
      function()
...
local _frmLojinha = {
    newEditor = newfrmLojinha, 
    new = newfrmLojinha, 
    name = "frmLojinha", 
    dataType = "LojaDinamica", 
    formType = "sheetTemplate", 
    formComponentName = "form", 
    title = "Loja Dinamica", 
    description=""};

frmLojinha = _frmLojinha;
Firecast.registrarForm(_frmLojinha);
Firecast.registrarDataType(_frmLojinha);
