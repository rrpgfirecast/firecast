...
local function constructNew_frmADnD5()
...
function newfrmADnD5()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmADnD5();
      end,
      function()
...
frmADnD5 = _frmADnD5;
Firecast.registrarForm(_frmADnD5);
