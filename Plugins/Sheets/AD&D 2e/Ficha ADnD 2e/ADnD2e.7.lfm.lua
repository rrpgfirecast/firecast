...
function newfrmADnD7()
    ...
    obj.image1:setSRC("/Ficha ADnD 2e/images/ADnD.png");
    ...
    obj.image2:setSRC("/Ficha ADnD 2e/images/RPGmeister.jpg");
    ...
    obj.label3:setText("Consultor: KONDAKJR (Kondak)");
    ...
    obj.label4:setText("Ficha feita para a mesa AD&D");
    ...
    obj.label5:setText("Sistema: AD&D 2e");
    ...
    obj.image3:setSRC("https://dl.dropboxusercontent.com/u/31086811/Plugins/Ficha%20ADnD%20releases/versao01.png");
    obj.image3:setName("image3");

    obj.label7 = gui.fromHandle(_obj_newObject("label"));
    obj.label7:setParent(obj.scrollBox1);
    obj.label7:setLeft(755);
    obj.label7:setTop(325);
    obj.label7:setWidth(100);
    obj.label7:setHeight(20);
    obj.label7:setText("Ultima Versão: ");
    ...
    obj.image4:setSRC("https://dl.dropboxusercontent.com/u/31086811/Plugins/Ficha%20ADnD%20releases/release.png");
    ...
    obj.label8:setLeft(755);
    obj.label8:setTop(400);
    obj.label8:setWidth(200);
    obj.label8:setHeight(20);
    obj.label8:setText("Conheça as Mesas:");
