...
local function constructNew_frmFichaOdisseia2_02_L_svg()
    ...
    obj:beginUpdate();
    obj:setName("frmFichaOdisseia2_02_L_svg");
    obj:setAlign("client");
    obj:setTheme("light");
    ...
    obj.layout5:setLeft(352);
    obj.layout5:setTop(316);
    obj.layout5:setWidth(118);
    ...
    obj.layout13:setLeft(352);
    obj.layout13:setTop(386);
    obj.layout13:setWidth(118);
    ...
    obj.layout17:setLeft(352);
    obj.layout17:setTop(421);
    obj.layout17:setWidth(118);
    ...
    obj.layout25:setLeft(352);
    obj.layout25:setTop(489);
    ...
    obj.edit41:setHitTest(true);
    obj.edit41:setHint("Em caso de numero quebrado, use . ao invés de ,");
    ...
    obj.edit45:setHitTest(true);
    obj.edit45:setHint("Em caso de numero quebrado, use . ao invés de ,");
    ...
    obj.edit49:setHitTest(true);
    obj.edit49:setHint("Em caso de numero quebrado, use . ao invés de ,");
    obj.edit49:setField("PesoBracos");
    ...
    obj.edit53:setHitTest(true);
    obj.edit53:setHint("Em caso de numero quebrado, use . ao invés de ,");
    ...
    obj.edit57:setHitTest(true);
    obj.edit57:setHint("Em caso de numero quebrado, use . ao invés de ,");
    ...
    obj.edit61:setHitTest(true);
    obj.edit61:setHint("Em caso de numero quebrado, use . ao invés de ,");
    ...
    obj.edit65:setHitTest(true);
    obj.edit65:setHint("Em caso de numero quebrado, use . ao invés de ,");
    ...
    obj.edit69:setHitTest(true);
    obj.edit69:setHint("Em caso de numero quebrado, use . ao invés de ,");
    ...
    obj.edit71:setHitTest(true);
    obj.edit71:setHint("Em caso de numero quebrado, use . ao invés de ,");
...
function newfrmFichaOdisseia2_02_L_svg()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmFichaOdisseia2_02_L_svg();
      end,
      function()
...
local _frmFichaOdisseia2_02_L_svg = {
    newEditor = newfrmFichaOdisseia2_02_L_svg, 
    new = newfrmFichaOdisseia2_02_L_svg, 
    name = "frmFichaOdisseia2_02_L_svg", 
    dataType = "", 
    formType = "undefined", 
...
frmFichaOdisseia2_02_L_svg = _frmFichaOdisseia2_02_L_svg;
Firecast.registrarForm(_frmFichaOdisseia2_02_L_svg);

return _frmFichaOdisseia2_02_L_svg;
