...
local function constructNew_frmAbilityForm()
    ...
    obj.edit1:setField("ability");
    obj.edit1:setName("edit1");

    obj.edit2 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit2:setParent(obj.rectangle1);
    obj.edit2:setAlign("client");
    obj.edit2:setField("espec");
    ...
    obj.imageCheckBox1:setField("ability_1");
    ...
    obj.imageCheckBox2:setField("ability_2");
    ...
    obj.imageCheckBox3:setField("ability_3");
    ...
    obj.imageCheckBox4:setField("ability_4");
    ...
    obj.imageCheckBox5:setField("ability_5");
...
function newfrmAbilityForm()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmAbilityForm();
      end,
      function()
...
local _frmAbilityForm = {
    newEditor = newfrmAbilityForm, 
    new = newfrmAbilityForm, 
    name = "frmAbilityForm", 
    dataType = "", 
    formType = "undefined", 
...
frmAbilityForm = _frmAbilityForm;
Firecast.registrarForm(_frmAbilityForm);

return _frmAbilityForm;
