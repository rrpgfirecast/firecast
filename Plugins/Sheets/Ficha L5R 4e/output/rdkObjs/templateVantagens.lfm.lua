...
local function constructNew_templateVantagens()
    ...
    obj.popVantagem:setParent(obj.layout1);
    obj.popVantagem:setName("popVantagem");
    obj.popVantagem:setWidth(440);
    obj.popVantagem:setHeight(200);
    obj.popVantagem:setBackOpacity(0);
    obj.popVantagem:setDrawContainer(false);
    lfm_setPropAsString(obj.popVantagem, "autoScopeNode",  "true");

    obj.rectangle1 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle1:setParent(obj.popVantagem);
