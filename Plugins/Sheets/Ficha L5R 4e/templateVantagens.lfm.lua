...
local function constructNew_templateVantagens()
    ...
    obj.popMeuPopup:setTop(30);
    obj.popMeuPopup:setLeft(500);
    obj.popMeuPopup:setWidth(400);
    obj.popMeuPopup:setHeight(160);
    obj.popMeuPopup:setBackOpacity(0.5);

    obj.textEditor1 = GUI.fromHandle(_obj_newObject("textEditor"));
    obj.textEditor1:setParent(obj.popMeuPopup);
    ...
    obj._e_event0 = obj.labNome:addEventListener("onClick",
        function (_)
            self.popMeuPopup:show('right', self.labNome);
        end, obj);
