...
local function constructNew_frmDobra()
...
function newfrmDobra()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmDobra();
      end,
      function()
...
frmDobra = _frmDobra;
Firecast.registrarForm(_frmDobra);
