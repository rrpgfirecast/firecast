...
local function constructNew_frmWeaponConfig()
    ...
    obj.weaponType:setMargins({right=5});
    ...
    obj.checkBox5:setHint("Bônus minimo de força necessario para usar esse arco composto. Se não possuir força minima a penalidade já é aplicada. ");
    ...
    obj.checkBox6:setHint("Limita a quantidade de ataques usados em um ataque total. Util para caso o personagem não tenha todos talentos de combater com duas armas. ");
    ...
    obj.checkBox21:setText("Duas Mãos");
    obj.checkBox21:setField("combate2maos");
    obj.checkBox21:setHint("Marque se estiver usando a arma com as duas mãos");
    ...
    obj.checkBox27:setParent(obj.layout24);
    obj.checkBox27:setAlign("top");
    obj.checkBox27:setHeight(25);
    obj.checkBox27:setText("Flanquear");
    obj.checkBox27:setField("flanquear");
    obj.checkBox27:setHint("Marque se estiver flanquando o alvo. ");
    ...
    obj.checkBox28:setText("Força");
    obj.checkBox28:setField("useStr");
    ...
    obj.checkBox29:setText("Destreza");
    obj.checkBox29:setField("useDex");
    ...
    obj.checkBox30:setText("Constituição");
    obj.checkBox30:setField("useCon");
    ...
    obj.checkBox31:setText("Inteligência");
    obj.checkBox31:setField("useInt");
    ...
    obj.checkBox32:setText("Sabedoria");
    obj.checkBox32:setField("useSab");
    ...
    obj.checkBox33:setText("Carisma");
    obj.checkBox33:setField("useCar");
    obj.checkBox33:setHint("Marque se o modificador desse atributo entra no ataque.");
    ...
    obj.dataLink50:setFields({'furtivo', 'ataquePoderoso', 'especializacaoCombate', 'tiroMultiplo', 'ataqueMultiplo', 'alcance', 'composto', 'limite', 'energia', 'rajada', 'tamanho', 'talentos', 'itens', 'magias', 'extra', 'outros', 'outros1', 'outros2', 'outros3', 'outros4', 'combate2maos', 'combate2armas', 'combate2armasLeve', 'velocidade', 'tiroRapido', 'tiroRapidoAprimorado', 'flanquear', 'atualizar','useStr', 'multStr', 'useDex', 'multDex', 'useCon', 'multCon', 'useInt', 'multInt', 'useSab', 'multSab', 'useCar', 'multCar'});
