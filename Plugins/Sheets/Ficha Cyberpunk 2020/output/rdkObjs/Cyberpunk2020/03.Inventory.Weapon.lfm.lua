...
local function constructNew_frmInventoryWeapon()
    ...
    obj:beginUpdate();
    obj:setName("frmInventoryWeapon");
    obj:setWidth(725);
    obj:setHeight(25);
    ...
    obj._e_event1 = obj.dataLink1:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet==nil then return end;
            				...
            				local objetos = ndb.getChildNodes(node.weaponList);
            				local cost = 0;
...
function newfrmInventoryWeapon()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmInventoryWeapon();
      end,
      function()
...
local _frmInventoryWeapon = {
    newEditor = newfrmInventoryWeapon, 
    new = newfrmInventoryWeapon, 
    name = "frmInventoryWeapon", 
    dataType = "", 
    formType = "undefined", 
...
frmInventoryWeapon = _frmInventoryWeapon;
Firecast.registrarForm(_frmInventoryWeapon);

return _frmInventoryWeapon;
