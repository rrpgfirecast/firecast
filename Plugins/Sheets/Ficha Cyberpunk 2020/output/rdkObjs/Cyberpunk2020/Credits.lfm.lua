...
local function constructNew_frmTemplateCreditos()
    ...
    obj.image1:setSRC("/Cyberpunk2020/images/cyberpunk.png");
    ...
    obj.image2:setSRC("/Cyberpunk2020/images/RPGmeister.jpg");
    ...
    obj.label6:setText("Programador: Vinny (Ambesek)");
    ...
    obj.label7:setText("Consultor: francinha87");
    ...
    obj.button4:setText("Nova York 1920");
