...
function newfrmTemplateDescription()
    ...
    obj.label13:setText("ANTECEDENTE");
    ...
    obj.edit12:setField("antecedente");
    ...
    obj.layout2:setTop(255);
    obj.layout2:setWidth(375);
    obj.layout2:setHeight(140);
