...
local function constructNew_frmContractItem()
...
function newfrmContractItem()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmContractItem();
      end,
      function()
...
local _frmContractItem = {
    newEditor = newfrmContractItem, 
    new = newfrmContractItem, 
    name = "frmContractItem", 
    dataType = "", 
    formType = "undefined", 
...
frmContractItem = _frmContractItem;
Firecast.registrarForm(_frmContractItem);

return _frmContractItem;
