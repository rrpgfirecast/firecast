...
local function constructNew_frmFichaRPGmeister8_svg()
    ...
    obj.edit12:setField("iniciativaComp");
    ...
    obj.edit13:setField("iniciativaCompDesc");
    obj.edit13:setName("edit13");

    obj.label12 = GUI.fromHandle(_obj_newObject("label"));
    obj.label12:setParent(obj.rectangle3);
    obj.label12:setLeft(2);
    obj.label12:setTop(35);
    obj.label12:setWidth(85);
    obj.label12:setHeight(20);
    obj.label12:setText("Deslocamento");
    ...
    obj.edit14:setField("deslocamentoComp");
    ...
    obj.label16:setField("forModComp");
    ...
    obj.label17:setField("desModComp");
    ...
    obj.label18:setField("conModComp");
    ...
    obj.label19:setField("intModComp");
    ...
    obj.label20:setField("sabModComp");
    ...
    obj.label21:setField("carModComp");
    ...
    obj.label23:setParent(obj.rectangle13);
    ...
    obj.label24:setParent(obj.rectangle14);
    ...
    obj.label27:setParent(obj.rectangle15);
    ...
    obj.button11:setParent(obj.rectangle16);
    obj.button11:setLeft(55);
    obj.button11:setTop(150);
    obj.button11:setWidth(50);
    obj.button11:setHeight(20);
    obj.button11:setHint("Envia tudo do segundo espaço para ataques no chat.");
    obj.button11:setText("Atacar");
    ...
    obj._e_event2 = obj.edit19:addEventListener("onChange",
        function (_)
            local node = self.rclListaDosCompanheiros.selectedNode;
            					if node~=nil then
    ...
    obj._e_event4 = obj.edit21:addEventListener("onChange",
        function (_)
            local node = self.rclListaDosCompanheiros.selectedNode;
            					if node~=nil then
    ...
    obj._e_event6 = obj.edit23:addEventListener("onChange",
        function (_)
            local node = self.rclListaDosCompanheiros.selectedNode;
            					if node~=nil then
    ...
    obj._e_event8 = obj.edit25:addEventListener("onChange",
        function (_)
            local node = self.rclListaDosCompanheiros.selectedNode;
            					if node~=nil then
    ...
    obj._e_event10 = obj.edit27:addEventListener("onChange",
        function (_)
            local node = self.rclListaDosCompanheiros.selectedNode;
            					if node~=nil then
    ...
    obj._e_event12 = obj.edit29:addEventListener("onChange",
        function (_)
            local node = self.rclListaDosCompanheiros.selectedNode;
            					if node~=nil then
    ...
    obj._e_event20 = obj.rclListaDosCompanheiros:addEventListener("onSelect",
        function (_)
            local node = self.rclListaDosCompanheiros.selectedNode;
    ...
    obj._e_event21 = obj.rclListaDosCompanheiros:addEventListener("onEndEnumeration",
        function (_)
