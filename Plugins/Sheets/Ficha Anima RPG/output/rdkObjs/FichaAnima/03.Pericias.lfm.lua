...
local function constructNew_frmFichaRPGmeister3_svg()
    ...
    obj.checkBox4:setLeft(60);
    obj.checkBox4:setTop(5);
    obj.checkBox4:setWidth(19);
    obj.checkBox4:setHeight(15);
    obj.checkBox4:setField("idiomasIsClass");
    ...
    obj.button3:setText("Padrão Anima");
