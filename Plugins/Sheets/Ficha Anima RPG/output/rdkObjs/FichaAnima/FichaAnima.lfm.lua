...
local function constructNew_frmFichaAnima()
...
function newfrmFichaAnima()
    ...
    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmFichaAnima();
      end,
      function()
...
Firecast.registrarForm(_frmFichaAnima);
Firecast.registrarDataType(_frmFichaAnima);
