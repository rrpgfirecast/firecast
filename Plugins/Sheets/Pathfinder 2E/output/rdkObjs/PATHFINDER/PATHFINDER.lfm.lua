...
local function constructNew_frmPATHFINDER()
    ...
    obj.tab1:setTitle("Página 3");
    obj.tab1:setName("tab1");

    obj.frmPATHFINDER3_svg = GUI.fromHandle(_obj_newObject("form"));
    obj.frmPATHFINDER3_svg:setParent(obj.tab1);
    ...
    obj.scrollBox1:setParent(obj.frmPATHFINDER3_svg);
    ...
    obj.tab2:setTitle("Página 4");
    obj.tab2:setName("tab2");

    obj.frmPATHFINDER4_svg = GUI.fromHandle(_obj_newObject("form"));
    obj.frmPATHFINDER4_svg:setParent(obj.tab2);
    ...
    obj.scrollBox2:setParent(obj.frmPATHFINDER4_svg);
