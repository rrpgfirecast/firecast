...
local function constructNew_frmItemDepositado()
...
function newfrmItemDepositado()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmItemDepositado();
      end,
      function()
...
local _frmItemDepositado = {
    newEditor = newfrmItemDepositado, 
    new = newfrmItemDepositado, 
    name = "frmItemDepositado", 
    dataType = "", 
    formType = "undefined", 
...
frmItemDepositado = _frmItemDepositado;
Firecast.registrarForm(_frmItemDepositado);

return _frmItemDepositado;
