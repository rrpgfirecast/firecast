...
local function constructNew_frmEquipamento()
...
function newfrmEquipamento()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmEquipamento();
      end,
      function()
...
local _frmEquipamento = {
    newEditor = newfrmEquipamento, 
    new = newfrmEquipamento, 
    name = "frmEquipamento", 
    dataType = "", 
    formType = "undefined", 
...
frmEquipamento = _frmEquipamento;
Firecast.registrarForm(_frmEquipamento);

return _frmEquipamento;
