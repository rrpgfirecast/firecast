...
local function constructNew_frmAbilities()
    ...
    obj.edit1:setField("abilities_name");
    ...
    obj.edit2:setField("abilities_type");
    ...
    obj.edit3:setField("abilities_range");
    ...
    obj.edit4:setField("abilities_karma");
    ...
    obj.dataLink1:setField("abilities_karma");
