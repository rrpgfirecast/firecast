...
local function constructNew_frmGear()
    ...
    obj.edit2:setField("gear_rating");
    ...
    obj.edit4:setField("gear_weight");
    ...
    obj.dataLink1:setField("gear_price");
    obj.dataLink1:setName("dataLink1");

    obj.dataLink2 = GUI.fromHandle(_obj_newObject("dataLink"));
    obj.dataLink2:setParent(obj.rectangle1);
    obj.dataLink2:setField("gear_weight");
...
frmGear = _frmGear;
Firecast.registrarForm(_frmGear);
