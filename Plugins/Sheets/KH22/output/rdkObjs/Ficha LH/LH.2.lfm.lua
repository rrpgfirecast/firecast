...
function newfrmLH2()
    ...
    obj.boxDetalhesDoNinjutsu:setParent(obj.rectangle1);
    ...
    obj.rectangle2:setParent(obj.boxDetalhesDoNinjutsu);
    ...
    obj.edit1:setField("campoNinjutsu");
    ...
    obj.boxDetalhesDoGenjutsu:setParent(obj.rectangle3);
    ...
    obj.rectangle4:setParent(obj.boxDetalhesDoGenjutsu);
    ...
    obj.edit6:setField("campoGenjutsu");
    ...
    obj.boxDetalhesDoTaijutsu:setParent(obj.rectangle5);
    ...
    obj.rectangle6:setParent(obj.boxDetalhesDoTaijutsu);
    ...
    obj.edit11:setField("campoTaijutsu");
    ...
    obj._e_event1 = obj.rclListaDosNinjutsus:addEventListener("onSelect",
        function (self)
            --[[
    ...
    obj._e_event3 = obj.rclListaDosGenjutsus:addEventListener("onSelect",
        function (self)
            --[[
                        Este evento é chamado quando o usuário selecionar/deselecionar itens da lista. Quando o usuário selecionar, vamos fazer nosso dataScopeBox (e todas as tag dentro dele) salvar e carregar dados no   objeto Nodo (NodeDatabase) do item selecionado.
    ...
    obj._e_event5 = obj.rclListaDosTaijutsus:addEventListener("onSelect",
        function (self)
            --[[
                        Este evento é chamado quando o usuário selecionar/deselecionar itens da lista. Quando o usuário selecionar, vamos fazer nosso dataScopeBox (e todas as tag dentro dele) salvar e carregar dados no   objeto Nodo (NodeDatabase) do item selecionado.
