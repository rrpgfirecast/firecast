...
local function constructNew_frmEfeitoCombatTracker()
    ...
    obj.imgEfeito:setSRC("/GerenciadorSotDL/images/effect.png");
    ...
    obj.imgDeleteEfeito:setSRC("/GerenciadorSotDL/images/deleteEffect.png");
...
function newfrmEfeitoCombatTracker()
    ...
    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmEfeitoCombatTracker();
      end,
      function()
