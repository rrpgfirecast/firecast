...
local function constructNew_frmAtorCombatTracker()
    ...
    obj.imgVez:setSRC("/GerenciadorSotDL/images/vez.png");
    ...
    obj.imgDeleteAtor:setSRC("/GerenciadorSotDL/images/delete 2.png");
    ...
    obj.imgAddEfeito:setSRC("/GerenciadorSotDL/images/addEffect.png");
