...
local function constructNew_frmNPCList()
    ...
    obj.image1:setSRC("/GerenciadorSotDL/images/addlista.png");
    ...
    obj.image2:setSRC("/GerenciadorSotDL/images/config.png");
    ...
    obj.image3:setSRC("/GerenciadorSotDL/images/addnpc.png");
    ...
    obj.image4:setSRC("/GerenciadorSotDL/images/organize.png");
...
function newfrmNPCList()
    ...
    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmNPCList();
      end,
      function()
