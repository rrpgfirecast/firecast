...
local function constructNew_frmGerenciador03_AVENTURA()
    ...
    obj.cbxInvisivel:setImageChecked("/GerenciadorSotDL/images/invisivel2.png");
    obj.cbxInvisivel:setImageUnchecked("/GerenciadorSotDL/images/visivel2.png");
...
function newfrmGerenciador03_AVENTURA()
    ...
    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmGerenciador03_AVENTURA();
      end,
      function()
