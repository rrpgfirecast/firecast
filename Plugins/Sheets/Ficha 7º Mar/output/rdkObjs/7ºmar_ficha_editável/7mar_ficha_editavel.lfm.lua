...
local function constructNew_frm7mar_ficha_editavel()
    ...
    obj:beginUpdate();
    obj:setName("frm7mar_ficha_editavel");
    obj:setFormType("sheetTemplate");
    obj:setDataType("rrpg.ficha.7.mar");
    obj:setTitle("Ficha 7º Mar");
    obj:setAlign("client");
    obj:setTheme("light");

    obj.frm_7mar_ficha_editavel1_svg = GUI.fromHandle(_obj_newObject("form"));
    obj.frm_7mar_ficha_editavel1_svg:setParent(obj);
    obj.frm_7mar_ficha_editavel1_svg:setName("frm_7mar_ficha_editavel1_svg");
    obj.frm_7mar_ficha_editavel1_svg:setAlign("client");
    obj.frm_7mar_ficha_editavel1_svg:setTheme("light");
    obj.frm_7mar_ficha_editavel1_svg:setMargins({top=1});

    obj.scrollBox1 = GUI.fromHandle(_obj_newObject("scrollBox"));
    obj.scrollBox1:setParent(obj.frm_7mar_ficha_editavel1_svg);
    ...
    function obj:destroy() 
        ...
        if self.frm_7mar_ficha_editavel1_svg ~= nil then self.frm_7mar_ficha_editavel1_svg:destroy(); self.frm_7mar_ficha_editavel1_svg = nil; end;
...
function newfrm7mar_ficha_editavel()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frm7mar_ficha_editavel();
      end,
      function()
...
local _frm7mar_ficha_editavel = {
    newEditor = newfrm7mar_ficha_editavel, 
    new = newfrm7mar_ficha_editavel, 
    name = "frm7mar_ficha_editavel", 
    dataType = "rrpg.ficha.7.mar", 
    formType = "sheetTemplate", 
    formComponentName = "form", 
    title = "Ficha 7º Mar", 
    description=""};

frm7mar_ficha_editavel = _frm7mar_ficha_editavel;
Firecast.registrarForm(_frm7mar_ficha_editavel);
Firecast.registrarDataType(_frm7mar_ficha_editavel);

return _frm7mar_ficha_editavel;
