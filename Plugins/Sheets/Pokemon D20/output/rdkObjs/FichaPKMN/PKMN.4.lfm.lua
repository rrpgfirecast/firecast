...
local function constructNew_frmPKMN4()
...
function newfrmPKMN4()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmPKMN4();
      end,
      function()
...
frmPKMN4 = _frmPKMN4;
Firecast.registrarForm(_frmPKMN4);
