...
local function constructNew_frmPKMN5()
...
function newfrmPKMN5()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmPKMN5();
      end,
      function()
...
frmPKMN5 = _frmPKMN5;
Firecast.registrarForm(_frmPKMN5);
