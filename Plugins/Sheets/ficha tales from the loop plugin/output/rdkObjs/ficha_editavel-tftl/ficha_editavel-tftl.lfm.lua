...
local function constructNew_frmficha_editavel_tftl()
    ...
    obj:beginUpdate();
    obj:setName("frmficha_editavel_tftl");
    obj:setFormType("sheetTemplate");
    obj:setDataType("ficha_tftl");
    obj:setTitle("Ficha De RPG - Tales from the loop");
    obj:setAlign("client");
    obj:setTheme("light");

    obj.frmficha_editavel_tftl1_svg = GUI.fromHandle(_obj_newObject("form"));
    obj.frmficha_editavel_tftl1_svg:setParent(obj);
    obj.frmficha_editavel_tftl1_svg:setName("frmficha_editavel_tftl1_svg");
    obj.frmficha_editavel_tftl1_svg:setAlign("client");
    obj.frmficha_editavel_tftl1_svg:setTheme("light");
    obj.frmficha_editavel_tftl1_svg:setMargins({top=1});

    obj.scrollBox1 = GUI.fromHandle(_obj_newObject("scrollBox"));
    obj.scrollBox1:setParent(obj.frmficha_editavel_tftl1_svg);
    ...
    function obj:destroy() 
        ...
        if self.frmficha_editavel_tftl1_svg ~= nil then self.frmficha_editavel_tftl1_svg:destroy(); self.frmficha_editavel_tftl1_svg = nil; end;
...
function newfrmficha_editavel_tftl()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmficha_editavel_tftl();
      end,
      function()
...
local _frmficha_editavel_tftl = {
    newEditor = newfrmficha_editavel_tftl, 
    new = newfrmficha_editavel_tftl, 
    name = "frmficha_editavel_tftl", 
    dataType = "ficha_tftl", 
    formType = "sheetTemplate", 
    formComponentName = "form", 
    title = "Ficha De RPG - Tales from the loop", 
    description=""};

frmficha_editavel_tftl = _frmficha_editavel_tftl;
Firecast.registrarForm(_frmficha_editavel_tftl);
Firecast.registrarDataType(_frmficha_editavel_tftl);

return _frmficha_editavel_tftl;
