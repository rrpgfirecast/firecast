...
local function constructNew_frmFichaRPGmeister9_svg()
...
function newfrmFichaRPGmeister9_svg()
    ...
    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmFichaRPGmeister9_svg();
      end,
      function()
...
Firecast.registrarForm(_frmFichaRPGmeister9_svg);
