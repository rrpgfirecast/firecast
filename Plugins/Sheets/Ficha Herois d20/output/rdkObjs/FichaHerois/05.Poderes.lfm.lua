...
function newfrmPoderes()
    ...
    obj.label9:setText("Poderes Total");
    ...
    obj.label10:setField("sumPoderes");
    ...
    obj.label12:setField("reduction");
    ...
    obj.label13:setText("Poderes Efetivo");
    ...
    obj.label14:setField("efetPoderes");
