...
local function constructNew_frmFichaRPGmeister11_svg()
    ...
    obj.image1:setSRC("/FichaHerois/images/RPGmeister.jpg");
    ...
    obj.label2:setText("Sistema: Ambesek");
    ...
    obj.label8:setText("ANOTAÇÕES DO MESTRE");
    ...
    obj.button5:setLeft(620);
    obj.button5:setTop(500);
    ...
    obj.button7:setLeft(730);
    obj.button7:setTop(525);
