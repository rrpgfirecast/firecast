...
local function constructNew_frmOD1_svg()
...
function newfrmOD1_svg()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmOD1_svg();
      end,
      function()
...
frmOD1_svg = _frmOD1_svg;
Firecast.registrarForm(_frmOD1_svg);
