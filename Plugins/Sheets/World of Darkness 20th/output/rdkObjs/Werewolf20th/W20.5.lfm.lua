...
local function constructNew_frmW20_5()
...
function newfrmW20_5()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmW20_5();
      end,
      function()
...
frmW20_5 = _frmW20_5;
Firecast.registrarForm(_frmW20_5);
