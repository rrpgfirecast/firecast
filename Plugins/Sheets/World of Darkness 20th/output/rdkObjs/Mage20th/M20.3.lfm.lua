...
local function constructNew_frmM20_3()
    ...
    obj.label6:setText("TRANSPORTATION");
...
function newfrmM20_3()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmM20_3();
      end,
      function()
...
frmM20_3 = _frmM20_3;
Firecast.registrarForm(_frmM20_3);
