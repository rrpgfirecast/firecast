...
local function constructNew_frmVDA20_1()
...
function newfrmVDA20_1()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmVDA20_1();
      end,
      function()
...
frmVDA20_1 = _frmVDA20_1;
Firecast.registrarForm(_frmVDA20_1);
