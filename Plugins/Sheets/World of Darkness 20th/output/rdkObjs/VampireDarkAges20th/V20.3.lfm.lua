...
local function constructNew_frmVDA20_3()
...
function newfrmVDA20_3()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmVDA20_3();
      end,
      function()
...
frmVDA20_3 = _frmVDA20_3;
Firecast.registrarForm(_frmVDA20_3);
