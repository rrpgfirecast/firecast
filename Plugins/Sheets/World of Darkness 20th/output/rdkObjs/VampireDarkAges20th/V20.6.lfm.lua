...
local function constructNew_frmVDA20_6()
...
function newfrmVDA20_6()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmVDA20_6();
      end,
      function()
...
frmVDA20_6 = _frmVDA20_6;
Firecast.registrarForm(_frmVDA20_6);
