...
local function constructNew_frmVDA20_4()
...
function newfrmVDA20_4()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmVDA20_4();
      end,
      function()
...
frmVDA20_4 = _frmVDA20_4;
Firecast.registrarForm(_frmVDA20_4);
