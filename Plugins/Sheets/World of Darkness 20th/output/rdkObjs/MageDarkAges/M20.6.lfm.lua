...
local function constructNew_frmMDA20_6()
...
function newfrmMDA20_6()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmMDA20_6();
      end,
      function()
...
frmMDA20_6 = _frmMDA20_6;
Firecast.registrarForm(_frmMDA20_6);
