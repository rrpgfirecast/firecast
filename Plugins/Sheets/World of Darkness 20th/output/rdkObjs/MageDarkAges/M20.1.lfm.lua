...
local function constructNew_frmMDA20_1()
...
function newfrmMDA20_1()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmMDA20_1();
      end,
      function()
...
frmMDA20_1 = _frmMDA20_1;
Firecast.registrarForm(_frmMDA20_1);
