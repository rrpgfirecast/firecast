...
local function constructNew_frmTemplateCreditos()
    ...
    obj.image1:setSRC("/Ficha Tormenta 20/images/fulgurante.jpg");
    ...
    obj.image2:setSRC("/Ficha Tormenta 20/images/RPGmeister.jpg");
    ...
    obj.label1:setText("Ficha feita por: ");
    ...
    obj.label3:setText("Willian (sqwert00)");
    ...
    obj.dataLink1:setDefaultValue("Claro");
    ...
    obj.dataLink2:setDefaultValue("#F0FFFF");
    ...
    obj.dataLink3:setDefaultValue("#696969");
    ...
    obj.dataLink4:setDefaultValue("#000000");
