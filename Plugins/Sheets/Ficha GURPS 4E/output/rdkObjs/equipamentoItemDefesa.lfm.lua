...
local function constructNew_frmEquipamentoItemDefesa()
    ...
    obj.fraLayout:setMinScaledWidth(150);
    ...
    obj.labGridCampoSolido3:setText("POSIÇÃO");
    ...
    obj.labGridCampoSolido4:setText("DEFESA");
    ...
    obj.GridCampoSolido5:setMinScaledWidth(150);
    obj.GridCampoSolido5:setMinWidth(150);
    obj.GridCampoSolido5:setMaxWidth(360);
    obj.GridCampoSolido5:setMaxScaledWidth(360);
    ...
    obj.edtGridCampoSolido5:setField("propriedades");
    ...
    obj.labGridCampoSolido5:setText("PROPRIEDADES");
