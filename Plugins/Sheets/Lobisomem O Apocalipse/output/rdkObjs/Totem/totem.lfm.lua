...
local function constructNew_frmtotem()
    ...
    obj:beginUpdate();
    obj:setName("frmtotem");
    obj:setFormType("sheetTemplate");
    obj:setDataType("br.com.RRPG.WTFTV3_S3");
    obj:setTitle("Lobisomem: O Apocalipse - Ficha do Totem");
    obj:setAlign("client");
    obj:setTheme("light");

    obj.frmtotem1_svg = GUI.fromHandle(_obj_newObject("form"));
    obj.frmtotem1_svg:setParent(obj);
    obj.frmtotem1_svg:setName("frmtotem1_svg");
    obj.frmtotem1_svg:setAlign("client");
    obj.frmtotem1_svg:setTheme("light");
    obj.frmtotem1_svg:setMargins({top=1});

    obj.scrollBox1 = GUI.fromHandle(_obj_newObject("scrollBox"));
    obj.scrollBox1:setParent(obj.frmtotem1_svg);
    ...
    function obj:destroy() 
        ...
        if self.frmtotem1_svg ~= nil then self.frmtotem1_svg:destroy(); self.frmtotem1_svg = nil; end;
...
function newfrmtotem()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmtotem();
      end,
      function()
...
local _frmtotem = {
    newEditor = newfrmtotem, 
    new = newfrmtotem, 
    name = "frmtotem", 
    dataType = "br.com.RRPG.WTFTV3_S3", 
    formType = "sheetTemplate", 
    formComponentName = "form", 
    title = "Lobisomem: O Apocalipse - Ficha do Totem", 
    description=""};

frmtotem = _frmtotem;
Firecast.registrarForm(_frmtotem);
Firecast.registrarDataType(_frmtotem);
