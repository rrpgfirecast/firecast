...
local function constructNew_frmFichaRPGmeister4_svg()
    ...
    obj.label7:setText("TALENTOS COMUNS E DE CLASSE BÁSICA");
    ...
    obj.rclListaDosTalentosBase:setWidth(370);
    ...
    obj.label8:setText("TALENTOS DE CLASSE AVANÇADA");
    ...
    obj.rclListaDosTalentosAvanc:setWidth(370);
