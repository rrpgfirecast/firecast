...
local function constructNew_frmMagiaItemComCheckbox()
    ...
    obj.imageCheckBox1:setImageChecked("/Runarcana/images/checkbox1_checked.png");
    obj.imageCheckBox1:setImageUnchecked("/Runarcana/images/checkbox1_unchecked.png");
