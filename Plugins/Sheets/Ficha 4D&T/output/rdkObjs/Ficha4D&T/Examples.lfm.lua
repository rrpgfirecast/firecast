...
local function constructNew_frmExamples()
    ...
    obj.rectangle1:setColor("#FFFFFFFF");
    ...
    obj.rectangle6:setParent(obj.boxDetalhesDoItem);
    ...
    obj.rectangle7:setLeft(375);
    obj.rectangle7:setTop(290);
    ...
    obj.image2:setParent(obj.rectangle7);
...
function newfrmExamples()
    ...
    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmExamples();
      end,
      function()
