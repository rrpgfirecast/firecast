...
local function constructNew_CaixaFichaNPC()
    ...
    obj.imageCheckBox2:setImageChecked("/FichaReinosD20/images/organize.png");
    obj.imageCheckBox2:setImageUnchecked("/FichaReinosD20/images/organize.png");
    ...
    obj.imageCheckBox3:setImageChecked("/FichaReinosD20/images/delete.png");
    obj.imageCheckBox3:setImageUnchecked("/FichaReinosD20/images/delete.png");
