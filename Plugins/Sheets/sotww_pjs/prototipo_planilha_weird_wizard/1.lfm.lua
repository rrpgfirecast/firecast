...
local function constructNew_frmprototipo_planilha_weird_wizard1_svg()
    ...
    obj:beginUpdate();
    obj:setName("frmprototipo_planilha_weird_wizard1_svg");
    obj:setAlign("client");
    obj:setTheme("light");
...
function newfrmprototipo_planilha_weird_wizard1_svg()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmprototipo_planilha_weird_wizard1_svg();
      end,
      function()
...
local _frmprototipo_planilha_weird_wizard1_svg = {
    newEditor = newfrmprototipo_planilha_weird_wizard1_svg, 
    new = newfrmprototipo_planilha_weird_wizard1_svg, 
    name = "frmprototipo_planilha_weird_wizard1_svg", 
    dataType = "", 
    formType = "undefined", 
...
frmprototipo_planilha_weird_wizard1_svg = _frmprototipo_planilha_weird_wizard1_svg;
Firecast.registrarForm(_frmprototipo_planilha_weird_wizard1_svg);

return _frmprototipo_planilha_weird_wizard1_svg;
