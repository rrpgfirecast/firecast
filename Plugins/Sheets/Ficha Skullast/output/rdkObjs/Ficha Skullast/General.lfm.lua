...
function newfrmGeneral()
    ...
    obj._e_event42 = obj.dataLink22:addEventListener("onChange",
        function (self, field, oldValue, newValue)
            if sheet == nil then return end;
    ...
    obj._e_event46 = obj.dataLink24:addEventListener("onChange",
        function (self, field, oldValue, newValue)
            if sheet == nil then return end;
    ...
    obj._e_event48 = obj.checkBox1:addEventListener("onChange",
        function (self)
            if sheet==nil then return end;
            									sheet.firstValue = -1;
