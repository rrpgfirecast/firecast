...
function newfrmTemplateCreditos()
    ...
    obj.image3:setSRC("/Ficha Skullast/images/RPGmeister.jpg");
    ...
    obj.label3:setText("Consultor: Caiolternativo");
    ...
    obj.button4:setText("Skul Last br");
