...
local function constructNew_frmLH3_2()
    ...
    obj.dataLink1:setDefaultValue("Nome do Jutsu do Clan");
...
function newfrmLH3_2()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmLH3_2();
      end,
      function()
...
frmLH3_2 = _frmLH3_2;
Firecast.registrarForm(_frmLH3_2);
