...
local function constructNew_frmLH2_3()
    ...
    obj.dataLink1:setDefaultValue("Nome do Taijutsu");
...
function newfrmLH2_3()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmLH2_3();
      end,
      function()
...
frmLH2_3 = _frmLH2_3;
Firecast.registrarForm(_frmLH2_3);
