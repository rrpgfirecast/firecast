...
local function constructNew_frmLH4_3()
    ...
    obj.dataLink1:setDefaultValue("Nome do Estilo de Luta");
...
function newfrmLH4_3()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmLH4_3();
      end,
      function()
...
frmLH4_3 = _frmLH4_3;
Firecast.registrarForm(_frmLH4_3);
