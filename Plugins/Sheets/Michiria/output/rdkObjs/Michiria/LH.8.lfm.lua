...
local function constructNew_frmLH8()
    ...
    obj.image2:setSRC("/Michiria/images/RPGmeister.jpg");
    obj.image2:setName("image2");

    obj.layout1 = GUI.fromHandle(_obj_newObject("layout"));
    obj.layout1:setParent(obj.scrollBox1);
    obj.layout1:setLeft(360);
    obj.layout1:setTop(0);
    obj.layout1:setWidth(200);
    obj.layout1:setHeight(275);
    ...
    obj.label5:setText("Ficha modificada por:");
    ...
    obj.label8:setText("Ficha re-modificada por:");
    ...
    obj.label9:setText("Vinny (Ambesek)");
    obj.label9:setHorzTextAlign("center");
    obj.label9:setName("label9");

    obj.layout2 = GUI.fromHandle(_obj_newObject("layout"));
    obj.layout2:setParent(obj.scrollBox1);
    obj.layout2:setLeft(570);
    ...
    obj.label15:setText("Versão Atual: ");
    obj.label15:setHorzTextAlign("center");
    obj.label15:setField("versionInstalled");
    obj.label15:setName("label15");

    obj.label16 = GUI.fromHandle(_obj_newObject("label"));
    obj.label16:setParent(obj.scrollBox1);
    obj.label16:setLeft(570);
    obj.label16:setTop(200);
    obj.label16:setWidth(200);
    obj.label16:setHeight(20);
    obj.label16:setText("Sua Versão: ");
    obj.label16:setHorzTextAlign("center");
    obj.label16:setField("versionDownloaded");
    ...
    obj.button1:setLeft(570);
    obj.button1:setTop(250);
    obj.button1:setWidth(100);
    obj.button1:setText("Atualizar");
    obj.button1:setName("button1");

    obj.button2 = GUI.fromHandle(_obj_newObject("button"));
    obj.button2:setParent(obj.scrollBox1);
    obj.button2:setLeft(570);
    obj.button2:setTop(300);
    obj.button2:setWidth(100);
    obj.button2:setHeight(20);
    obj.button2:setText("Exportar Ficha");
    obj.button2:setName("button2");

    obj.button3 = GUI.fromHandle(_obj_newObject("button"));
    obj.button3:setParent(obj.scrollBox1);
    obj.button3:setLeft(570);
    obj.button3:setTop(325);
    obj.button3:setWidth(100);
    obj.button3:setHeight(20);
    obj.button3:setText("Importar Ficha");
