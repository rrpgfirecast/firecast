...
local function constructNew_frmLH4_1()
    ...
    obj.dataLink1:setDefaultValue("Nome do Kenjutsu");
...
function newfrmLH4_1()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmLH4_1();
      end,
      function()
...
frmLH4_1 = _frmLH4_1;
Firecast.registrarForm(_frmLH4_1);
