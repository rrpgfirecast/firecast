...
local function constructNew_frmL5A1_svg()
...
function newfrmL5A1_svg()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmL5A1_svg();
      end,
      function()
...
frmL5A1_svg = _frmL5A1_svg;
Firecast.registrarForm(_frmL5A1_svg);
