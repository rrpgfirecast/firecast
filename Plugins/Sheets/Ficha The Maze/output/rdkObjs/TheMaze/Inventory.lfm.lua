...
local function constructNew_frmInventory()
    ...
    obj.label1:setTop(5);
    obj.label1:setWidth(895);
    obj.label1:setHeight(25);
    obj.label1:setHorzTextAlign("center");
    obj.label1:setText("Equipados");
    ...
    obj.label3:setText("Equipamento");
    ...
    obj.label5:setTop(5);
    obj.label5:setWidth(310);
    obj.label5:setHeight(25);
    obj.label5:setHorzTextAlign("center");
    obj.label5:setText("Armazenamento");
