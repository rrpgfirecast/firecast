...
local function constructNew_frmFichaRPGmeister3_svg()
    ...
    obj.label26:setText("PONTOS GASTOS");
    obj.label26:setLeft(0);
    obj.label26:setTop(0);
    obj.label26:setWidth(135);
    ...
    obj.button3:setText("Pathfinder");
