...
local function constructNew_frmCreditos()
    ...
    obj.image1:setSRC("/Ficha 3D&T Turbo/images/RPGmeister.jpg");
    obj.image1:setName("image1");

    obj.layout1 = GUI.fromHandle(_obj_newObject("layout"));
    obj.layout1:setParent(obj.scrollBox1);
    obj.layout1:setLeft(300);
...
function newfrmCreditos()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmCreditos();
      end,
      function()
...
frmCreditos = _frmCreditos;
Firecast.registrarForm(_frmCreditos);
