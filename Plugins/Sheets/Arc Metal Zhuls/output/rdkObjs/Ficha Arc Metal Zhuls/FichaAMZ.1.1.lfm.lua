...
local function constructNew_frmAMZ1_1()
...
function newfrmAMZ1_1()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmAMZ1_1();
      end,
      function()
...
frmAMZ1_1 = _frmAMZ1_1;
Firecast.registrarForm(_frmAMZ1_1);
