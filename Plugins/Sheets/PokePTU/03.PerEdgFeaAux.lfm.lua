...
local function constructNew_frmPokePerEdgeFea1()
    ...
    obj:beginUpdate();
    obj:setName("frmPokePerEdgeFea1");
    obj:setHeight(25);
    obj:setWidth(350);
    obj:setMargins({top=2});
		...
		local function showHabilidadePopup()
			local pop = self:findControlByName("popHabilidade1");
...
function newfrmPokePerEdgeFea1()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmPokePerEdgeFea1();
      end,
      function()
...
local _frmPokePerEdgeFea1 = {
    newEditor = newfrmPokePerEdgeFea1, 
    new = newfrmPokePerEdgeFea1, 
    name = "frmPokePerEdgeFea1", 
    dataType = "", 
    formType = "undefined", 
...
frmPokePerEdgeFea1 = _frmPokePerEdgeFea1;
Firecast.registrarForm(_frmPokePerEdgeFea1);

return _frmPokePerEdgeFea1;
