...
local function constructNew_frmPokePerEdgeFea2()
    ...
    obj:beginUpdate();
    obj:setName("frmPokePerEdgeFea2");
    obj:setHeight(25);
    obj:setWidth(350);
...
function newfrmPokePerEdgeFea2()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmPokePerEdgeFea2();
      end,
      function()
...
local _frmPokePerEdgeFea2 = {
    newEditor = newfrmPokePerEdgeFea2, 
    new = newfrmPokePerEdgeFea2, 
    name = "frmPokePerEdgeFea2", 
    dataType = "", 
    formType = "undefined", 
...
frmPokePerEdgeFea2 = _frmPokePerEdgeFea2;
Firecast.registrarForm(_frmPokePerEdgeFea2);

return _frmPokePerEdgeFea2;
