...
local function constructNew_frmTemplateCreditos()
    ...
    obj.image1:setSRC("/WarhammerFantasy/images/Bretonnia.jpg");
    ...
    obj.image2:setSRC("/WarhammerFantasy/images/RPGmeister.jpg");
    ...
    obj.label3:setText("Consultor: NinjaKai");
    ...
    obj.button4:setText("WF: Bretonnia");
