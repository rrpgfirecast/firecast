...
local function constructNew_CaixaFichaNPC2()
    ...
    obj.TipoDeBarras = GUI.fromHandle(_obj_newObject("popup"));
    ...
    obj.imgApagar:setImageChecked("/ListaNPCsLista/images/delete.png");
    obj.imgApagar:setImageUnchecked("/ListaNPCsLista/images/delete.png");
    ...
    obj.imgFalar:setImageChecked("/ListaNPCsLista/images/voice.png");
    obj.imgFalar:setImageUnchecked("/ListaNPCsLista/images/voice.png");
    ...
    obj.imgBloquear:setImageChecked("/ListaNPCsLista/images/bloqueado.png");
    obj.imgBloquear:setImageUnchecked("/ListaNPCsLista/images/desbloqueado.png");
    ...
    obj.cbxInvisivel:setImageChecked("/ListaNPCsLista/images/invisivel.png");
    obj.cbxInvisivel:setImageUnchecked("/ListaNPCsLista/images/visivel.png");
    ...
    obj.imgInfo:setImageChecked("/ListaNPCsLista/images/info.png");
    obj.imgInfo:setImageUnchecked("/ListaNPCsLista/images/info.png");
    ...
    obj._e_event3 = obj.TipoDeBarras:addEventListener("onClose",
        function (_, canceled)
...
function newCaixaFichaNPC2()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_CaixaFichaNPC2();
      end,
      function()
...
local _CaixaFichaNPC2 = {
    newEditor = newCaixaFichaNPC2, 
    new = newCaixaFichaNPC2, 
    name = "CaixaFichaNPC2", 
    dataType = "", 
    formType = "undefined", 
...
CaixaFichaNPC2 = _CaixaFichaNPC2;
Firecast.registrarForm(_CaixaFichaNPC2);

return _CaixaFichaNPC2;
