...
local function constructNew_Listade_NPC_Ficha()
    ...
    obj:beginUpdate();
    obj:setName("Listade_NPC_Ficha");
    obj:setFormType("sheetTemplate");
    obj:setDataType("Lista.de.NPC.Ficha");
    obj:setTitle("Lista de NPCs (Ficha)");
    obj:setAlign("client");
    obj:setTheme("dark");
    ...
    obj.Config = GUI.fromHandle(_obj_newObject("popup"));
    obj.Config:setParent(obj.layout1);
    obj.Config:setName("Config");
    obj.Config:setWidth(412);
    obj.Config:setHeight(190);
    lfm_setPropAsString(obj.Config, "autoScopeNode",  "false");
    ...
    obj.dcsTituloEAbas = GUI.fromHandle(_obj_newObject("layout"));
    ...
    obj.layout31:setParent(obj);
    obj.layout31:setVisible(false);
    obj.layout31:setName("layout31");

    obj.dropDownFalso2 = GUI.fromHandle(_obj_newObject("popup"));
    obj.dropDownFalso2:setParent(obj.layout31);
    obj.dropDownFalso2:setName("dropDownFalso2");
    obj.dropDownFalso2:setWidth(128);
    obj.dropDownFalso2:setHeight(128);
    obj.dropDownFalso2:setBackOpacity(0);
    lfm_setPropAsString(obj.dropDownFalso2, "autoScopeNode",  "false");
    ...
    obj.Configurar:setImageChecked("/ListaNPCsLista/images/config.png");
    obj.Configurar:setImageUnchecked("/ListaNPCsLista/images/config.png");

    obj.NovoNPC = GUI.fromHandle(_obj_newObject("imageCheckBox"));
    obj.NovoNPC:setParent(obj.layout32);
    ...
    obj.NovoNPC:setImageChecked("/ListaNPCsLista/images/addnpc.png");
    obj.NovoNPC:setImageUnchecked("/ListaNPCsLista/images/addnpc.png");

    obj.Organizar = GUI.fromHandle(_obj_newObject("imageCheckBox"));
    obj.Organizar:setParent(obj.layout32);
    ...
    obj.Organizar:setImageChecked("/ListaNPCsLista/images/organize.png");
    obj.Organizar:setImageUnchecked("/ListaNPCsLista/images/organize.png");

    obj.label13 = GUI.fromHandle(_obj_newObject("label"));
    obj.label13:setParent(obj.layout32);
    obj.label13:setAlign("left");
    obj.label13:setMargins({left=12});
    obj.label13:setAutoSize(true);
    obj.label13:setField("NomeDaOpcao");
    obj.label13:setName("label13");

    obj.dataLink7 = GUI.fromHandle(_obj_newObject("dataLink"));
    obj.dataLink7:setParent(obj.rectangle27);
    obj.dataLink7:setField("NomeDaOpcao");
    obj.dataLink7:setDefaultValue("Lista de NPCs");
    obj.dataLink7:setName("dataLink7");

    obj.dataLink8 = GUI.fromHandle(_obj_newObject("dataLink"));
    obj.dataLink8:setParent(obj.rectangle27);
    obj.dataLink8:setField("TipoOrganizar");
    obj.dataLink8:setDefaultValue("Alfa");
    obj.dataLink8:setName("dataLink8");

    obj.MainClient = GUI.fromHandle(_obj_newObject("scrollBox"));
    obj.MainClient:setParent(obj.rectangle27);
    ...
    obj.rclListaDeNPC:setTemplateForm("CaixaFichaNPC2");
    ...
    obj.layout33:setParent(obj.rectangle27);
    obj.layout33:setAlign("bottom");
    obj.layout33:setHeight(32);
    obj.layout33:setName("layout33");

    obj.label14 = GUI.fromHandle(_obj_newObject("label"));
    obj.label14:setParent(obj.layout33);
    ...
    obj.dataLink9:setParent(obj.rectangle27);
    obj.dataLink9:setFields({'VisibBarrinha1', 'VisibBarrinha2', 'VisibBarrinha3', 'VisibBarrinha4'});
    obj.dataLink9:setDefaultValues({'a', 'a', 'a', 'a'});
    obj.dataLink9:setName("dataLink9");

    obj.dataLink10 = GUI.fromHandle(_obj_newObject("dataLink"));
    obj.dataLink10:setParent(obj.rectangle27);
    obj.dataLink10:setFields({'NumerosBarrinha1', 'NumerosBarrinha2', 'NumerosBarrinha3', 'NumerosBarrinha4'});
    obj.dataLink10:setDefaultValues({'x', 'x', 'x', 'x'});
    ...
    obj._e_event2 = obj.rectangle1:addEventListener("onClick",
        function (_)
    ...
    obj._e_event3 = obj.rectangle2:addEventListener("onClick",
        function (_)
            sheet.IndexBarrinha = 1;
            							sheet.CorIndex = sheet.IndexBarrinha1;
            							sheet.ColorString = sheet.CorBarrinha1;
    ...
    obj._e_event4 = obj.CorBarrinha1:addEventListener("onClick",
        function (_)
            sheet.IndexBarrinha = 1;
            								sheet.CorIndex = sheet.IndexBarrinha1;
            								sheet.ColorString = sheet.CorBarrinha1;
    ...
    obj._e_event6 = obj.rectangle3:addEventListener("onClick",
        function (_)
    ...
    obj._e_event8 = obj.CorBarrinha2:addEventListener("onClick",
        function (_)
            sheet.IndexBarrinha = 2;
            								sheet.CorIndex = sheet.IndexBarrinha2;
            								sheet.ColorString = sheet.CorBarrinha2;
    ...
    obj._e_event10 = obj.rectangle5:addEventListener("onClick",
        function (_)
    ...
    obj._e_event12 = obj.CorBarrinha3:addEventListener("onClick",
        function (_)
            sheet.IndexBarrinha = 3;
            								sheet.CorIndex = sheet.IndexBarrinha3;
            								sheet.ColorString = sheet.CorBarrinha3;
    ...
    obj._e_event14 = obj.rectangle7:addEventListener("onClick",
        function (_)
    ...
    obj._e_event16 = obj.CorBarrinha4:addEventListener("onClick",
        function (_)
            sheet.IndexBarrinha = 4;
            								sheet.CorIndex = sheet.IndexBarrinha4;
            								sheet.ColorString = sheet.CorBarrinha4;
    ...
    obj._e_event19 = obj.layout14:addEventListener("onClick",
        function (_)
            sheet.CorIndex = "0";
    ...
    obj._e_event21 = obj.layout15:addEventListener("onClick",
        function (_)
            sheet.CorIndex = "1";
            				sheet.ColorString = "#5959ff";
        end, obj);

    obj._e_event22 = obj.rectangle12:addEventListener("onClick",
        function (_)
            sheet.CorIndex = "1";
            					sheet.ColorString = "#5959ff";
        end, obj);

    obj._e_event23 = obj.layout16:addEventListener("onClick",
        function (_)
            sheet.CorIndex = "2";
            				sheet.ColorString = "#59ff59";
        end, obj);

    obj._e_event24 = obj.rectangle13:addEventListener("onClick",
        function (_)
            sheet.CorIndex = "2";
            					sheet.ColorString = "#59ff59";
        end, obj);

    obj._e_event25 = obj.layout17:addEventListener("onClick",
        function (_)
            sheet.CorIndex = "3";
            				sheet.ColorString = "#ff5959";
        end, obj);

    obj._e_event26 = obj.rectangle14:addEventListener("onClick",
        function (_)
            sheet.CorIndex = "3";
            					sheet.ColorString = "#ff5959";
        end, obj);

    obj._e_event27 = obj.layout18:addEventListener("onClick",
        function (_)
            sheet.CorIndex = "4";
            				sheet.ColorString = "#ff59ff";
        end, obj);

    obj._e_event28 = obj.rectangle15:addEventListener("onClick",
        function (_)
            sheet.CorIndex = "4";
            					sheet.ColorString = "#ff59ff";
        end, obj);

    obj._e_event29 = obj.layout19:addEventListener("onClick",
        function (_)
            sheet.CorIndex = "5";
            				sheet.ColorString = "#ffac59";
        end, obj);

    obj._e_event30 = obj.rectangle16:addEventListener("onClick",
        function (_)
            sheet.CorIndex = "5";
            					sheet.ColorString = "#ffac59";
        end, obj);

    obj._e_event31 = obj.layout20:addEventListener("onClick",
        function (_)
            sheet.CorIndex = "6";
            				sheet.ColorString = "#ffff59";
        end, obj);

    obj._e_event32 = obj.rectangle17:addEventListener("onClick",
        function (_)
            sheet.CorIndex = "6";
            					sheet.ColorString = "#ffff59";
        end, obj);

    obj._e_event33 = obj.layout21:addEventListener("onClick",
        function (_)
            sheet.CorIndex = "7";
            				sheet.ColorString = "#59ffff";
        end, obj);

    obj._e_event34 = obj.rectangle18:addEventListener("onClick",
        function (_)
            sheet.CorIndex = "7";
            					sheet.ColorString = "#59ffff";
        end, obj);

    obj._e_event35 = obj.layout22:addEventListener("onClick",
        function (_)
            sheet.CorIndex = "8";
            				sheet.ColorString = "#ffd159";
        end, obj);

    obj._e_event36 = obj.rectangle19:addEventListener("onClick",
        function (_)
            sheet.CorIndex = "8";
            					sheet.ColorString = "#ffd159";
        end, obj);

    obj._e_event37 = obj.layout23:addEventListener("onClick",
        function (_)
            sheet.CorIndex = "9";
            				sheet.ColorString = "#5990ff";
        end, obj);

    obj._e_event38 = obj.rectangle20:addEventListener("onClick",
        function (_)
            sheet.CorIndex = "9";
            					sheet.ColorString = "#5990ff";
        end, obj);

    obj._e_event39 = obj.layout24:addEventListener("onClick",
        function (_)
            sheet.CorIndex = "10";
            				sheet.ColorString = "#f4c264";
        end, obj);

    obj._e_event40 = obj.rectangle21:addEventListener("onClick",
        function (_)
            sheet.CorIndex = "10";
            					sheet.ColorString = "#f4c264";
        end, obj);

    obj._e_event41 = obj.layout25:addEventListener("onClick",
        function (_)
            sheet.CorIndex = "11";
            				sheet.ColorString = "#de7a7a";
        end, obj);

    obj._e_event42 = obj.rectangle22:addEventListener("onClick",
        function (_)
            sheet.CorIndex = "11";
            					sheet.ColorString = "#de7a7a";
        end, obj);

    obj._e_event43 = obj.layout26:addEventListener("onClick",
        function (_)
            sheet.CorIndex = "12";
            				sheet.ColorString = "#cb83d6";
        end, obj);

    obj._e_event44 = obj.rectangle23:addEventListener("onClick",
        function (_)
            sheet.CorIndex = "12";
            					sheet.ColorString = "#cb83d6";
        end, obj);

    obj._e_event45 = obj.layout27:addEventListener("onClick",
        function (_)
            sheet.CorIndex = "13";
            				sheet.ColorString = "#f3658a";
        end, obj);

    obj._e_event46 = obj.rectangle24:addEventListener("onClick",
        function (_)
            sheet.CorIndex = "13";
            					sheet.ColorString = "#f3658a";
        end, obj);

    obj._e_event47 = obj.layout28:addEventListener("onClick",
        function (_)
            sheet.CorIndex = "14";
            				sheet.ColorString = "#8cecb3";
        end, obj);

    obj._e_event48 = obj.rectangle25:addEventListener("onClick",
        function (_)
            sheet.CorIndex = "14";
            					sheet.ColorString = "#8cecb3";
        end, obj);

    obj._e_event49 = obj.layout29:addEventListener("onClick",
        function (_)
            sheet.CorIndex = "15";
            				sheet.ColorString = "#ed846b";
        end, obj);

    obj._e_event50 = obj.rectangle26:addEventListener("onClick",
        function (_)
            sheet.CorIndex = "15";
            					sheet.ColorString = "#ed846b";
        end, obj);
    ...
    obj._e_event52 = obj.opcoesFalsas2:addEventListener("onSelect",
        function (_)
    ...
    obj._e_event53 = obj.opcoesFalsas2:addEventListener("onCompare",
    ...
    obj._e_event54 = obj.rectangle27:addEventListener("onResize",
        function (_)
    ...
    obj._e_event55 = obj.Configurar:addEventListener("onClick",
        function (_)
            if DonoMestre() then
    ...
    obj._e_event56 = obj.NovoNPC:addEventListener("onClick",
        function (_)
            if DonoMestre() then			
    ...
    obj._e_event57 = obj.Organizar:addEventListener("onClick",
        function (_)
            if DonoMestre() then			
    ...
    obj._e_event58 = obj.rclListaDeNPC:addEventListener("onBeginEnumeration",
        function (_)
        end, obj);

    obj._e_event59 = obj.rclListaDeNPC:addEventListener("onItemAdded",
    ...
    obj._e_event60 = obj.rclListaDeNPC:addEventListener("onCompare",
        function (_, nodeA, nodeB)
            org = getOrganizacao();
    ...
    obj._e_event61 = obj.dataLink9:addEventListener("onChange",
        function (_, field, oldValue, newValue)
    ...
    obj._e_event62 = obj.dataLink10:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            local nodes = ndb.getChildNodes(sheet.campoDosNPC);    
            				self:beginUpdate();
            				for i = 1,#nodes, 1 do
...
function newListade_NPC_Ficha()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_Listade_NPC_Ficha();
      end,
      function()
...
local _Listade_NPC_Ficha = {
    newEditor = newListade_NPC_Ficha, 
    new = newListade_NPC_Ficha, 
    name = "Listade_NPC_Ficha", 
    dataType = "Lista.de.NPC.Ficha", 
    formType = "sheetTemplate", 
    formComponentName = "form", 
    title = "Lista de NPCs (Ficha)", 
    description=""};

Listade_NPC_Ficha = _Listade_NPC_Ficha;
Firecast.registrarForm(_Listade_NPC_Ficha);
Firecast.registrarDataType(_Listade_NPC_Ficha);

return _Listade_NPC_Ficha;
