...
local function constructNew_frmEnemy()
    ...
    obj.dataLink1:setFields({'nd'});
    obj.dataLink1:setName("dataLink1");

    obj.dataLink2 = GUI.fromHandle(_obj_newObject("dataLink"));
    obj.dataLink2:setParent(obj);
    obj.dataLink2:setFields({'nd','qtd'});
...
function newfrmEnemy()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmEnemy();
      end,
      function()
...
frmEnemy = _frmEnemy;
Firecast.registrarForm(_frmEnemy);
