...
local function constructNew_frmScepterItem()
    ...
    obj.label7:setField("price");
    obj.label7:setHorzTextAlign("center");
    lfm_setPropAsString(obj.label7, "formatFloat",  ",0.## PO");
...
function newfrmScepterItem()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmScepterItem();
      end,
      function()
...
local _frmScepterItem = {
    newEditor = newfrmScepterItem, 
    new = newfrmScepterItem, 
    name = "frmScepterItem", 
    dataType = "", 
    formType = "undefined", 
...
frmScepterItem = _frmScepterItem;
Firecast.registrarForm(_frmScepterItem);

return _frmScepterItem;
