...
local function constructNew_frmWeaponItem()
...
function newfrmWeaponItem()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmWeaponItem();
      end,
      function()
...
local _frmWeaponItem = {
    newEditor = newfrmWeaponItem, 
    new = newfrmWeaponItem, 
    name = "frmWeaponItem", 
    dataType = "", 
    formType = "undefined", 
...
frmWeaponItem = _frmWeaponItem;
Firecast.registrarForm(_frmWeaponItem);

return _frmWeaponItem;
