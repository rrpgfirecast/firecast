...
local function constructNew_frmFichaOdisseia2_01_L_svg()
    ...
    obj:beginUpdate();
    obj:setName("frmFichaOdisseia2_01_L_svg");
    obj:setAlign("client");
    obj:setTheme("light");
...
function newfrmFichaOdisseia2_01_L_svg()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmFichaOdisseia2_01_L_svg();
      end,
      function()
...
local _frmFichaOdisseia2_01_L_svg = {
    newEditor = newfrmFichaOdisseia2_01_L_svg, 
    new = newfrmFichaOdisseia2_01_L_svg, 
    name = "frmFichaOdisseia2_01_L_svg", 
    dataType = "", 
    formType = "undefined", 
...
frmFichaOdisseia2_01_L_svg = _frmFichaOdisseia2_01_L_svg;
Firecast.registrarForm(_frmFichaOdisseia2_01_L_svg);

return _frmFichaOdisseia2_01_L_svg;
