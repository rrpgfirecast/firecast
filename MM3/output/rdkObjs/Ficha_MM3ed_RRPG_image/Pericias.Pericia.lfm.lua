        ...
        function (self)
            if sheet ~= nil then
            				...
            				if sheet.chavePericia == "1" then
            					atributoPericia = tonumber(node.For) or 0;
            				elseif sheet.chavePericia == "2" then
            					atributoPericia = tonumber(node.VIG or 0);
            				elseif sheet.chavePericia == "3" then
            					atributoPericia = tonumber(node.AGI or 0);
            				elseif sheet.chavePericia == "4" then
            					atributoPericia = tonumber(node.DES or 0);
            				elseif sheet.chavePericia == "5" then
            					atributoPericia = tonumber(node.LUT or 0);
            				elseif sheet.chavePericia == "6" then
            					atributoPericia = tonumber(node.INT or 0);
            				elseif sheet.chavePericia == "7" then
            					atributoPericia = tonumber(node.PRO or 0);
            				elseif sheet.chavePericia == "8" then
            					atributoPericia = tonumber(node.PRE or 0);
            				end;
